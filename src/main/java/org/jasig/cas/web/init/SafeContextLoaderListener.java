 ...
 * our entire site application context. Use of this ContextListener will not be
 * appropriate for all deployments of a site application. Sometimes, a context
 ...
 * is configured in the site.xml via the standard error handling mechanism.
 ...
 * site.xml is a one for one replacement for {@link ContextLoaderListener}.
 * <p>
    ...
    public void contextInitialized(final ServletContextEvent sce) {
        try {
            ...
            final String message = "SafeContextLoaderListener: \n"
                ...
                + "But for our having caught this error, the site application context would not have initialized.";
