...
public final class InitialFlowSetupAction extends AbstractAction {
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
      ...
      //add by cht for register
 	   ...
 	   String registerUrl = request.getContextPath() + "/register" + (queryString != null ? "?" + queryString : "");
 		context.getFlowScope().put("registerUrl", registerUrl);
 		
 		//add by cht for retakeP
  	   String retakePUrl = request.getContextPath() + "/retakeP" + (queryString != null ? "?" + queryString : "");
  		context.getFlowScope().put("retakePUrl", retakePUrl);
